...
function GetListOfFiles (nFileList, sDirectory, sFileType, bSubDirs) {
   ...
   /* The summary info line at end of a Find In Files search is
      language depended as also the name of the results document.
      Adapt the following 2 strings to your version of UE/UES. */
   ...
   if (bListCreated == false) {
      if (nOutputType == 2) {
         ...
         UltraEdit.outputWindow.write("                \"sSummaryInfo\" or \"sResultsDocTitle\" is not adapted to your version of UE/UES!");
      }
      return false;
   }
