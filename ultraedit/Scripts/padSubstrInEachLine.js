// ----------------------------------------------------------------------------
// Script Name: padSubstrInEachLine.js
...
var currentLine = UltraEdit.activeDocument.selection;
var columnNumber = 0;
if( delString == "" )
	delString = UltraEdit.getString("Substring to left pad",1);
columnNumber = UltraEdit.getString("Column number to pad to",1);
...
UltraEdit.outputWindow.write("NOT WORKING YET!!!!");
